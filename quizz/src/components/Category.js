    ...
    return (
      <main className="w-2/3 mx-auto">
        ...
        {!this.state.categories && (
          <h2 className="text-center font-bold py-4">Loading...</h2>
        )}
        ...
        <section>
              ...
              ? this.state.categories.map((c) => {
                  return (
                    <span
                      key={c.id}
                      className={
                        " py-2 px-3 my-2 mx-2 cursor-pointer text-white rounded-lg " +
          ...
          {this.state.categories ? (
            <>
              ...
              <div className="flex justify-center">
                <span
                  className={
                    "text-white py-2 px-3 rounded-lg mx-3  cursor-pointer" +
                    (difficultyLevel === "easy"
                      ? " bg-green-500 "
                      : " bg-pink-800 hover:bg-pink-600")
                  }
                  data-type="difficultyLevel"
                  data-id="easy"
                  onClick={(e) => this.handleClick(e)}
                >
                  Easy
          ...
          <div className="text-center py-8">
            ...
            >
              <button
                className={
                  categoryId && difficultyLevel && questions
                    ? "visible bg-black text-white py-2 px-3 rounded-lg font-bold"
                    : "hidden"
                }
              >
                Start Quiz
